...
import UpdateTreeUseCase from "../../../useCases/treeUseCases/updateTreeUseCase/updateTreeUseCase";
...
const DashboardUserDetails: NextPage<DashboardUserDetailsProps> = ({
	id,
	...
	const handleSubmit = (event: FormEvent<HTMLFormElement>) => {
		...
		if (!tree.image) {
			return NotificationService.dangerNotification(
				"Error!",
				"You should select a tree image"
			);
		}
							...
							<div className="flex flex-row">
								<div className="w-1/2 m-5">
									...
									<TextEditor
										...
										onChange={(e: string) => {
											if (e != tree.description && e != undefined)
